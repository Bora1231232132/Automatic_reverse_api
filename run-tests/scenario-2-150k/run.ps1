...
try {
    ...
    $xml1 = $xml1 -replace '8888777666', $uniqueRef -replace 'CRTTOURKHPPXXX1738390000888', $msgId1 -replace '2026-01-30', $today
...
try {
    ...
    $xml2 = $xml2 -replace '8888777666', $uniqueRef -replace 'CRTBKRTKHPPXXX1738390100999', $msgId2 -replace '2026-01-30', $today

# Scenario 4: Content Pairing - 50,000 KHR
...
Write-Host "  Scenario 4 - 50,000 KHR" -ForegroundColor Cyan
Write-Host "  ext_ref: $uniqueRef" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

Write-Host "[Step 1] TOUR -> BKRT (50,000 KHR)..." -ForegroundColor Yellow
try {
    $xml1 = Get-Content -Path "test-scenarios/scenario4-small-amount/scenario4-step1-original.xml" -Raw -Encoding UTF8
    $xml1 = $xml1 -replace '3333222211', $uniqueRef -replace 'CRTTOURKHPPXXX1738285000555', $msgId1 -replace '2026-01-30', $today
...
try {
    ...
    $xml2 = $xml2 -replace '3333222211', $uniqueRef2 -replace 'CRTBKRTKHPPXXX1738285100666', $msgId2 -replace '2026-01-30', $today
